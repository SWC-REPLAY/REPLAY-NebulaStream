...
PhysicalPlan apply(
    ...
    std::shared_ptr<StoreManager::StoreRegistry> storeRegistry) /// NOLINT
{
    const auto registryArgument = LoweringRuleRegistryArguments{.conf = conf, .storeRegistry = std::move(storeRegistry)};
