...
TEST_F(SystestParserInvalidTestFilesTest, InvalidErrorCodeTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string& query, const SystestQueryId, bool, bool) { ASSERT_EQ(query, expectQuery); });
...
TEST_F(SystestParserInvalidTestFilesTest, InvalidErrorMessageTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string& query, SystestQueryId, bool, bool) { ASSERT_EQ(query, expectQuery); });
...
TEST_F(SystestParserInvalidTestFilesTest, InvalidTokenTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string&, SystestQueryId, bool, bool) { /* nop, ensure parsing*/ });
