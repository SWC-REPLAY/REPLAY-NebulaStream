...
TEST_F(SystestParserInvalidTestFilesTest, InvalidErrorCodeTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string& query, const SystestQueryId, bool, const std::optional<std::string>&) { ASSERT_EQ(query, expectQuery); });
...
TEST_F(SystestParserInvalidTestFilesTest, InvalidErrorMessageTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string& query, SystestQueryId, bool, const std::optional<std::string>&) { ASSERT_EQ(query, expectQuery); });
...
TEST_F(SystestParserInvalidTestFilesTest, InvalidTokenTest)
{
    ...
    SystestParser parser{};
    parser.registerOnQueryCallback([&](const std::string&, SystestQueryId, bool, const std::optional<std::string>&) { /* nop, ensure parsing*/ });
